...
const TOWNS = [
  ...
  { name: "Chincoteague", coords: [-75.378, 37.933], desc: "Home of the world-famous wild ponies and pristine Atlantic beaches.", attractions: ["Assateague Lighthouse", "Wild Pony Viewing", "Misty Museum"] },
  ...
  { name: "Parksley", coords: [-75.649, 37.790], desc: "A historic railroad town with beautiful Victorian architecture.", attractions: ["Railway Museum", "Historic Five-and-Dime", "Town Square"] },
  { name: "Accomac", coords: [-75.666, 37.722], desc: "The historic county seat, filled with 18th-century architecture.", attractions: ["Ker Place Museum", "Historic Court Green", "Federal Mansions"] },
  { name: "Onancock", coords: [-75.743, 37.711], desc: "A vibrant port town known for its arts scene and fine dining.", attractions: ["Tangier Ferry", "Historic Wharf District", "North Street Playhouse"] },
  { name: "Wachapreague", coords: [-75.688, 37.607], desc: "The 'Little City by the Sea,' a premier destination for fishing.", attractions: ["Charter Fishing", "Island House Restaurant", "Marine Center"] },
...
export default function TownTour() {
  ...
  return (
    <main className="flex flex-col md:flex-row min-h-screen bg-slate-950 overflow-hidden">
      ...
      <div className="w-full md:w-1/3 h-screen overflow-y-scroll snap-y snap-mandatory z-10 no-scrollbar md:order-1 relative mt-[50vh] md:mt-0 pb-[100vh]">
        {TOWNS.map((town) => (
